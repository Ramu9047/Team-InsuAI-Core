...
export default function Sidebar() {
  ...
  return (
    <div className="card" style={{
      ...
      <Link to="/" style={{ padding: "0 10px 20px 10px", display: "flex", alignItems: "center", gap: "10px", textDecoration: "none" }}>
        <img src="/logo.svg" alt="InsurAI Logo" style={{ height: '32px', width: 'auto' }} />
        <h2 style={{ margin: 0, fontSize: 24, background: "var(--gradient-main)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", fontWeight: 800 }}>
          InsurAI
        </h2>
      </Link>
      {user && (
